...
public class OptionSet {
	 ...
	 *           If the <code>key</code> is <code>null</code> or unknown in this
	 *           set
	 */
	...
	/**
	 * Return the data items found (these are the items on the command line which
	 * do not start with the prefix, i. e. non-option arguments)
	 * <p>
	 * 
	...
	/**
	 * Add a non-value option with the given key, and the default prefix and
	 * multiplicity
	 * <p>
	 * 
	 * @param key
	 ...
	 *         <p>
	 * @throws IllegalArgumentException
	 *           If the <code>key</code> is <code>null</code> or a key with this
	...
	/**
	 * Add a non-value option with the given key and multiplicity, and the default
	 * prefix
	 * <p>
	 * 
	 * @param key
	 ...
	 * @throws IllegalArgumentException
	 *           If the <code>key</code> is <code>null</code> or a key with this
	 *           name has already been defined or if <code>multiplicity</code> is
	 *           <code>null</code>
	 */
	...
	/**
	 * Add a value option with the given key and separator, no details, and the
	 ...
	 * @throws IllegalArgumentException
	 *           If the <code>key</code> is <code>null</code> or a key with this
	 *           name has already been defined or if <code>separator</code> is
	 *           <code>null</code>
	 */
	...
	/**
	 * Add a value option with the given key, separator, and multiplicity, no
	 ...
	 * @throws IllegalArgumentException
	 *           If the <code>key</code> is <code>null</code> or a key with this
	 *           name has already been defined or if <code>separator</code> or
	...
	/**
	 * 
	 * Add a value option with the given key and separator, possibly details, and
	 * the default prefix and multiplicity
	 * <p>
	 * 
	 * @param key
	 *          The key for the option
	...
	/**
	 * Add a value option with the given key, separator, and multiplicity,
	 * possibly details, and the default prefix
	 * <p>
	 * 
	 * @param key
	 *          The key for the option
	...
	/**
	 * The master method to add an option. Since there are combinations which are
	 * not acceptable (like a NONE separator and a true value), this method is not
	 * public. Internally, we only supply acceptable combinations.
	 */

	OptionSet addOption(String key, boolean details, Options.Separator separator,
	    boolean value, Options.Multiplicity multiplicity) {
