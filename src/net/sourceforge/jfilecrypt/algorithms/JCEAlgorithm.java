...
/**
 * This class provides the jFileCrypt-own encryption-functionality using the
 * Java Cryptography Extensions in javax.crypto and the JCA in java.security.
...
public class JCEAlgorithm implements Algorithm {
	...
	public JCEAlgorithm(String name) {
		...
		if (algName.equals("Blowfish")) {
			...
			Application.getController().displayError(
			    Application.getResourceBundle().getString("unknown_alg_title"),
			    Application.getResourceBundle().getString("unknown_alg_text"));
		...
		if (password == null || password.length() < 1) {
			Application.getController().displayError(
			    ...
			    Application.getResourceBundle()
			        .getString("password_not_null_message"));
			return false;
		}
		try {
	...
	public String getWebsite() {
		return Application.getResourceBundle().getString(
		    "url_" + algName.toLowerCase());
	}
