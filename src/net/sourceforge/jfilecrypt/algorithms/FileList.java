...
/**
 * This class is an simple utility which encapsulates a Vector<File>. It
 * provides only those methods an algorithm should be able to call on the
 * underlying Vector.
 * 
 * @since 0.2.1
 */
...
public class FileList {
	...
	/**
	 * This constructor parses a string containing a list of files separated by
	 * the second argument.
	 * 
	 * @param files
	 * @param separator
	...
	/**
	 * like FileList(File[] files), but it uses an java.util.List instead of an
	 * array.
	 * 
	 * @param list
	 */
