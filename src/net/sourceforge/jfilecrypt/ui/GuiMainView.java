...
public class GuiMainView extends JFrameExtended {
	...
	/**
	 * This is the main GUI frame. It communicates with the @see GuiMainController
	 * only and the GuiMainController is the only one who communicates with this
	 * class.
	 */
	...
	private void init() {
		try {
			setIconImage(new ImageIcon(AboutFrame.class.getResource("icon.png"))
			    .getImage());
		...
		lbCmpLevel.setHorizontalAlignment(JLabel.LEFT);
		...
		getContentPane().add(
		    jpInput,
		    new GridBagConstraints(0, 0, 1, 1, 1.0, 3.0, GridBagConstraints.CENTER,
		...
		jpInput.add(lbSource, new GridBagConstraints(0, 0, 1, 1, 1.0, 1.0,
		    GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0,
		        8), 0, 0));
		jpInput.add(tfPath, new GridBagConstraints(1, 0, 1, 1, 3.0, 1.0,
		    GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0,
		        8), 0, 0));
		jpInput.add(btChoose, new GridBagConstraints(2, 0, 1, 1, 1.0, 1.0,
		    GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0,
		        0), 0, 0));
		jpInput.add(lbAlgorithm, new GridBagConstraints(0, 1, 1, 1, 1.0, 1.0,
		    GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(8, 0, 0,
		        8), 0, 0));
		jpInput.add(cmbAlgorithm, new GridBagConstraints(1, 1, 1, 1, 3.0, 1.0,
		    GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(8, 0, 0,
		        8), 0, 0));
		jpInput.add(btAlgInfo, new GridBagConstraints(2, 1, 1, 1, 1.0, 1.0,
		    GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(8, 0, 0,
		        0), 0, 0));

		jpInput.add(lbCmpLevel, new GridBagConstraints(0, 3, 1, 1, 1.0, 1.0,
		    GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(8, 0, 0,
		        -18), 0, 0));
		jpInput.add(cmbCompressionLevel, new GridBagConstraints(1, 3, 1, 1, 1.0,
		    1.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(8,
		        0, 0, 8), 0, 0));
		jpInput.add(Box.createRigidArea(new Dimension(btAlgInfo.getWidth(), 5)),
		    new GridBagConstraints(2, 3, 1, 1, 1.0, 1.0, GridBagConstraints.CENTER,
		...
		jpProgress.add(pbCryptProgress, new GridBagConstraints(0, 0, 1, 1, 25.0,
		    1.0, GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(0, 0,
		        0, 0), 0, 0));

		jpProgress.add(btStop, new GridBagConstraints(1, 0, 1, 1, 1.0, 1.0,
		    GridBagConstraints.EAST, GridBagConstraints.VERTICAL, new Insets(0, 0,
		        0, 0), 0, 0));

		jpProgress.add(btAbout, new GridBagConstraints(2, 0, 1, 1, 1.0, 1.0,
		    GridBagConstraints.EAST, GridBagConstraints.VERTICAL, new Insets(0, 0,
		        0, 0), 0, 0));
	...
	/**
	 * Sets the current (chosen) algorithm name in the algorithm list to the given
	 * name.
	 */
	...
	/**
	 * Returns the current (chosen) algorithm name in the algorithm list.
	 */
	...
	/**
	 * Depending on whether there is a progress running some buttons may be
	 * en-/disabled (e.g. the Encrypt button).
	 */
