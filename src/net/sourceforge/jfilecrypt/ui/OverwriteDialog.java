...
/**
 * This is an input dialog for passwords. It is a modal input box with hidden
 * password input. The window accepts key events, ESC closes the window, ENTER
 * accepts the input.
 */
public class OverwriteDialog extends JDialog {
	...
	public OverwriteDialog(final JFrame parent) {
		...
		pnlMain.add(lbFile, new GridBagConstraints(0, 0, 1, 1, 1.0, 3.0,
		    GridBagConstraints.LINE_START, GridBagConstraints.HORIZONTAL,
		    new Insets(0, 0, 0, 0), 0, 0));
		pnlMain.add(cbAllFiles, new GridBagConstraints(0, 1, 1, 1, 1.0, 3.0,
		    GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0,
		        0), 0, 0));
		pnlMain.add(btNo, new GridBagConstraints(0, 2, 1, 1, 1.0, 3.0,
		    GridBagConstraints.LINE_END, GridBagConstraints.NONE, new Insets(0, 0,
		        0, 0), 0, 0));
		pnlMain.add(btYes, new GridBagConstraints(1, 2, 1, 1, 1.0, 3.0,
		    GridBagConstraints.LINE_START, GridBagConstraints.NONE, new Insets(0,
		        0, 0, 0), 0, 0));
