...
public class AboutFrame extends JFrameExtended {
	...
	private void init() {
		...
		lbWebsite
		    .setText("<html><a href=\"http://sourceforge.net/projects/jfilecrypt\">http://sourceforge.net/projects/jfilecrypt</a><html>");
		...
		jScrollPane1.setBorder(new javax.swing.border.TitledBorder(
		    new javax.swing.border.LineBorder(new java.awt.Color(0, 51, 255), 1,
		        true), bundle.getString("license"),
